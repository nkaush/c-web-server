...
/**
 * Uses the Jenkins's one_at_a_time algorithm to generate a hash for 'elem',
 * which must be a valid C-string (or a NULL pointer). The implementation is a 
 * modified version of the implementation found here:
 * 
